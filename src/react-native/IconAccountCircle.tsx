...
export interface IconAccountCircleProps extends SvgProps {
  size?: number;
}

export const IconAccountCircle: React.FC<IconAccountCircleProps> = ({
  size,
  width = 24,
  height = 24,
  ...props
