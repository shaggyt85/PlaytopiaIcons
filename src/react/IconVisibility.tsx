...
export interface IconVisibilityProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconVisibility: React.FC<IconVisibilityProps> = ({
  size,
  width = 24,
  height = 24,
  ...props
